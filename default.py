...
def get_args_parser():
    parser = argparse.ArgumentParser('Set gat detector', add_help=False)
    ...
    parser.add_argument('--enc_layers', default=6, type=int,
                        help="Number of encoding layers in the gat")
    parser.add_argument('--dec_layers', default=6, type=int,
                        help="Number of decoding layers in the gat")
    parser.add_argument('--dim_feedforward', default=2048, type=int,
                        help="Intermediate size of the feedforward layers in the gat blocks")
    parser.add_argument('--hidden_dim', default=256, type=int,
                        help="Size of the embeddings (dimension of the gat)")
    parser.add_argument('--dropout', default=0.1, type=float,
                        help="Dropout applied in the gat")
    parser.add_argument('--nheads', default=8, type=int,
                        help="Number of attention heads inside the gat's attentions")
    ...
    # Dataset parameters.
    parser.add_argument('--dataset_file', choices=['hico', 'vcoco'], required=True)
...
def main(args):
    ...
    if args.backbone == 'resnet50':
        pretrain_model = './data/pmgat_coco/pmgat-r50-e632da11.pth'
    elif args.backbone == 'resnet101':
        pretrain_model = './data/pmgat_coco/pmgat-r101-2c7b67e5.pth'
    else:
        pretrain_model = None
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('HOI gat training script', parents=[get_args_parser()])
